...
- [ ] 1. Project scaffolding and tooling
  - [-] 1.1 Scaffold the Next.js App Router project
    ...
    - _Requirements: 2.5_
  - [~] 1.2 Configure the Vitest + fast-check test harness
    ...
    - _Requirements: 23.5_
  - [~] 1.3 Implement the server-only environment and credential config module
...
- [ ] 2. Shared Zod schemas and domain types
  - [~] 2.1 Define shared enums, Zod schemas, and workflow I/O schemas
  ...
  - [~] 2.2 Write unit tests for shared schema validation
...
- [ ] 3. SSRF URL guard
  - [~] 3.1 Implement the SSRF URL guard
    ...
    - _Requirements: 8.2_
  - [~] 3.2 Write property test for the SSRF guard
    - **Feature: signalvault, Property 7: SSRF guard blocks internal address ranges and admits public hosts**
    - **Validates: Requirements 8.2**

- [ ] 4. InsForge database schema and security
  - [~] 4.1 Author migrations for all ten tables
  ...
  - [~] 4.2 Author RLS policies and the scan-status realtime trigger
...
- [ ] 6. Adapter interfaces and selection factory
  - [~] 6.1 Define adapter interfaces and shared adapter types
    ...
    - _Requirements: 23.1_
  - [~] 6.2 Implement the demo/live adapter selection factory
...
- [ ] 7. InsForge adapter and workspace-scoped repository
  - [~] 7.1 Implement the live InsForgeClient and WorkspaceRepository
  ...
  - [~] 7.2 Implement the demo in-memory InsForgeClient store
  ...
  - [~] 7.3 Write property test for workspace scoping
    - **Feature: signalvault, Property 1: Workspace scoping excludes other tenants**
    - **Validates: Requirements 1.4**

- [ ] 8. Authentication and active-workspace resolution
  - [~] 8.1 Implement middleware and active-workspace resolution
  ...
  - [~] 8.2 Write property test for active-workspace resolution
    - **Feature: signalvault, Property 3: Authentication establishes exactly one active workspace**
    - **Validates: Requirements 1.2, 1.3**

- [ ] 9. Apify adapter
  - [~] 9.1 Implement the live ApifyClient.capture
  ...
  - [~] 9.2 Implement the demo ApifyClient
  ...
  - [~] 9.3 Write property test for capture result shape and skips
  ...
  - [~] 9.4 Write property test for Apify failure fallback
...
- [ ] 10. Content normalization
  - [~] 10.1 Implement HTML normalization and hashing
...
- [ ] 11. Box adapter
  ...
  - [~] 11.2 Implement the demo/mock BoxClient
  ...
  - [~] 11.3 Write property test for artifact subfolder routing
    - **Feature: signalvault, Property 12: Box artifacts are routed to the type-matched subfolder**
    - **Validates: Requirements 10.1, 10.2**
  - [~] 11.4 Write property test for Box failure fallback
...
- [ ] 12. Diff engine and serialization
  - [~] 12.1 Implement change_score and diff computation
    ...
    - _Requirements: 11.2_
  - [~] 12.2 Implement diff serialization and deserialization
...
- [ ] 13. Model adapter
  ...
  - [~] 13.2 Implement the demo ModelClient
  ...
  - [~] 13.3 Write property test for provider precedence
    - **Feature: signalvault, Property 30: Model routing prefers the InsForge Model Gateway**
    - **Validates: Requirements 24.2**

- [ ] 14. Demo data seeding (Acme AI)
  - [~] 14.1 Implement the Demo_Company seed and deterministic fallback verdict
  ...
  - [~] 14.2 Write property test for demo determinism
    - **Feature: signalvault, Property 27: Demo Mode is deterministic across repeated scans**
    - **Validates: Requirements 18.7**
  - [~] 14.3 Write unit test for the seeded verdict value
    - Assert the demo verdict equals "Moving upmarket" with confidence 82
    - _Requirements: 18.5_

- [~] 15. Checkpoint - adapters and core libraries
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 16. Claim analysis agents
  - [~] 16.1 Implement the claimExtractorAgent
  ...
  - [~] 16.5 Write property test for classification defaults
    - **Feature: signalvault, Property 20: Classification assigns exactly one valid status with defined defaults**
    - **Validates: Requirements 14.1, 14.2, 14.3**

- [ ] 17. Courtroom debate agents
  - [~] 17.1 Implement the defenseAgent and prosecutorAgent
  ...
  - [~] 17.2 Implement the judgeAgent and deterministic fallback substitution
...
- [ ] 18. Mastra workflow steps and assembly
  - [~] 18.1 Implement createScanStep and planWatchTargetsStep
  ...
  - [~] 18.2 Implement runApifyCaptureStep, normalizeArtifactsStep, and uploadSnapshotToBoxStep
  ...
  - [~] 18.3 Write property test for artifact identifier persistence round-trip
    - **Feature: signalvault, Property 13: Uploaded artifact identifiers round-trip to persistence**
    - **Validates: Requirements 10.3**
  - [~] 18.4 Implement findPreviousSnapshotStep and computeDiffStep
  ...
  - [~] 18.5 Write property test for prior snapshot selection
    - **Feature: signalvault, Property 15: Prior snapshot selection picks the most recent earlier completed scan**
    - **Validates: Requirements 11.1**
  - [~] 18.6 Implement extractClaimsStep, classifyClaimsStep, runDebateStep, and writeBriefToBoxStep
...
- [ ] 20. API routes
  - [~] 20.1 Implement POST /api/companies and GET /api/companies
  ...
  - [~] 20.5 Implement GET /api/companies/:id and POST /api/companies/:id/sources
...
- [ ] 22. UI components
  - [~] 22.1 Implement CompanyCard and RunScanButton
  ...
  - [~] 22.2 Implement WatchedSourcesTable and AddCompanyForm
  ...
  - [~] 22.4 Implement DiffViewer, ClaimLedger, and ClaimStatusBadge
  ...
  - [~] 22.5 Implement RiskBadge, StrategyVerdictCard, CourtroomAnalysis, EvidenceArtifactList, and BoxEvidenceLink
...
- [ ] 23. Pages
  - [~] 23.1 Implement the landing page `/`
  ...
  - [~] 23.2 Write unit test for landing content and integration order
  ...
  - [~] 23.5 Implement the Company detail page `/companies/[id]`
