...
/**
 * `POST /api/integrations/apify` — store the Apify Integration configuration
 * for the active workspace (Requirements 21.6, 22.2, 22.3, 22.4, 22.5).
 *
...
export async function POST(request: NextRequest) {
  return handleStoreIntegration(request, "Apify");
}
